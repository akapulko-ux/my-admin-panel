export const translations = {
  en: {
    ...
    navigation: {
      ...
      publicInvestorTitle: 'PROPWAY',
      publicInvestorSubtitle: 'Property made simple',
    ...
    settings: {
      ...
      telegram: {
        ...
        description: 'Connect your Telegram account to receive client lead notifications',
        connected: 'Connected',
...
_________________               _________________
  (signature)                            (signature)`,
    ...
    propertiesGallery: {
      ...
      missingFieldsHint: 'Fill in these fields to increase the property rating',
  ...
  ru: {
    ...
    navigation: {
      ...
      publicInvestorTitle: 'PROPWAY',
      publicInvestorSubtitle: 'Путь к надежной недвижимости',
    ...
    settings: {
      ...
      telegram: {
        ...
        description: 'Подключите аккаунт Telegram для получения уведомлений о заявках клиентов',
        connected: 'Подключен',
...
_________________               _________________
  (подпись)                            (подпись)`,
    ...
    propertiesGallery: {
      ...
      missingFieldsHint: 'Заполните эти поля для повышения рейтинга объекта',
  ...
  id: {
    ...
    navigation: {
      ...
      publicInvestorTitle: 'PROPWAY',
      publicInvestorSubtitle: 'Properti jadi mudah',
    ...
    settings: {
      ...
      telegram: {
        ...
        description: 'Hubungkan akun Telegram Anda untuk menerima notifikasi permintaan klien',
        connected: 'Terhubung',
...
_________________               _________________
  (tanda tangan)                       (tanda tangan)`,
    ...
    propertiesGallery: {
      ...
      missingFieldsHint: 'Lengkapi bidang-bidang ini untuk meningkatkan peringkat properti',
