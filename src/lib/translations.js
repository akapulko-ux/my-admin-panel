...
_________________               _________________
  (signature)                            (signature)`,
    ...
    notifications: {
      ...
      subtitle: 'Отправка информационных сообщений агентам через iOS приложение',
      sendMessage: 'Отправить сообщение агентам',
      titleLabel: 'Заголовок',
      titlePlaceholder: 'Введите заголовок сообщения',
      bodyLabel: 'Текст сообщения',
      bodyPlaceholder: 'Введите текст сообщения для агентов',
      recipientsLabel: 'Получатели',
      recipients: 'Получателей',
      agents: 'Агенты',
      premiumAgents: 'Премиум агенты',
      admins: 'Администраторы',
      moderators: 'Модераторы',
      sendButton: 'Отправить сообщение',
      sending: 'Отправка...',
      userStats: 'Статистика получателей',
      recipientsStats: 'Статистика получателей',
      iosDevices: 'iOS устройств',
      byLanguage: 'По языкам:',
      history: 'История отправленных сообщений',
      noNotifications: 'Нет отправленных сообщений',
      loadingStats: 'Загрузка статистики...',
      recipients: 'получателей',
      success: 'успешно',
      failed: 'неудачно',
      fillRequired: 'Заполните заголовок и текст уведомления',
      sendError: 'Ошибка отправки уведомлений',
      statsError: 'Ошибка загрузки статистики',
      sendSuccess: 'Уведомления отправлены: {success} успешно, {failed} неудачно',
...
_________________               _________________
  (tanda tangan)                       (tanda tangan)`,
    ...
    notifications: {
      ...
      subtitle: 'Kirim pesan informasi ke agen melalui aplikasi iOS',
      sendMessage: 'Kirim pesan ke agen',
      titleLabel: 'Judul',
      titlePlaceholder: 'Masukkan judul pesan',
      bodyLabel: 'Teks pesan',
      bodyPlaceholder: 'Masukkan teks pesan untuk agen',
      recipientsLabel: 'Penerima',
      recipients: 'Penerima',
      agents: 'Agen',
      premiumAgents: 'Agen Premium',
      admins: 'Administrator',
      moderators: 'Moderator',
      sendButton: 'Kirim pesan',
      sending: 'Mengirim...',
      userStats: 'Statistik penerima',
      recipientsStats: 'Statistik penerima',
      iosDevices: 'Perangkat iOS',
      byLanguage: 'Berdasarkan bahasa:',
      history: 'Riwayat pesan terkirim',
      noNotifications: 'Tidak ada pesan terkirim',
      loadingStats: 'Memuat statistik...',
      recipients: 'penerima',
      success: 'berhasil',
      failed: 'gagal',
      fillRequired: 'Silakan isi judul dan teks pesan',
      sendError: 'Error mengirim notifikasi',
      statsError: 'Error memuat statistik',
      sendSuccess: 'Notifikasi terkirim: {success} berhasil, {failed} gagal',
      historyError: 'Error memuat riwayat',
      russian: 'Rusia',
      english: 'Inggris',
      indonesia: 'Indonesia'
    }
