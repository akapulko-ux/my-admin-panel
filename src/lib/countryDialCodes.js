// Minimal comprehensive list of international country calling codes
// Labels are indicative; multiple countries may share a code
export const countryDialCodes = [
  { code: '+1', label: 'US/CA & NANP' },
  ...
  { code: '+508', label: 'Saint Pierre & Miquelon' },
  ...
  { code: '+672', label: 'Antarctica/Heard' },
