    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 mb-8">
          <h1 className="text-2xl font-bold text-gray-900 mb-6">{t.investorHighlights}</h1>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-200">
                  <th className="text-left py-3 px-4 text-sm font-medium text-gray-500">{t.year}</th>
                  <th className="text-left py-3 px-4 text-sm font-medium text-gray-500">{t.income}</th>
                  <th className="text-left py-3 px-4 text-sm font-medium text-gray-500">{t.cumulativeIncome}</th>
                  <th className="text-left py-3 px-4 text-sm font-medium text-gray-500">{t.totalSpend}</th>
                  <th className="text-left py-3 px-4 text-sm font-medium text-gray-500">{t.cumulativeSpend}</th>
                  <th className="text-left py-3 px-4 text-sm font-medium text-gray-500">{t.cashFlow}</th>
                  <th className="text-left py-3 px-4 text-sm font-medium text-gray-500">{t.cumulativeCashflow}</th>
                </tr>
              </thead>
              <tbody>
                {currentData.detailedProjection.map((row, index) => (
                  <tr key={index} className="border-b border-gray-100">
                    ...
                    <td className="py-3 px-4 text-sm text-gray-900">{row.yearLabel}</td>
                    <td className="py-3 px-4 text-sm font-bold text-gray-900">{formatCurrency(row.income)}</td>
                    <td className="py-3 px-4 text-sm font-bold text-gray-900">{formatCurrency(row.cumulativeIncome)}</td>
                    <td className="py-3 px-4 text-sm text-gray-900">{formatCurrency(row.spend)}</td>
                    <td className="py-3 px-4 text-sm font-bold text-gray-900">{formatCurrency(row.cumulativeSpend)}</td>
                    <td className="py-3 px-4 text-sm text-gray-900">{formatCurrency(row.cashflow)}</td>
                    <td className="py-3 px-4 text-sm font-bold text-gray-900">{formatCurrency(row.cumulativeCashflow)}</td>
                  </tr>
                ))}
              </tbody>
            </table>
