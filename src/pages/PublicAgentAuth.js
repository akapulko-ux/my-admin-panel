...
export default function PublicAgentAuth() {
  ...
  //               {language === 'ru' 
  //                 ? 'В это время вы можете скачать и установить наше приложение PROPWAY для риэлторов на iPhone и iPad. В нём вы найдёте полный список комплексов и объектов из балийских застройщиков и множество удобных инструментов для риэлторов.'
  //                 : language === 'id'
  //                 ? 'Dalam waktu yang sama, Anda dapat mengunduh dan menginstal aplikasi PROPWAY untuk agen real estate di iPhone dan iPad. Di dalamnya Anda akan menemukan daftar lengkap kompleks dan properti dari pengembang Bali dan banyak alat yang nyaman untuk agen real estate.'
  //                 : 'In the meantime, you can download and install our PROPWAY app for realtors on iPhone and iPad. In it you will find a complete listing of complexes and properties from Bali developers and many convenient tools for realtors.'
  //               }
  //             </p>
  //           </div>
  ...
  //               </svg>
  //               {language === 'ru' ? 'Установить PROPWAY' : language === 'id' ? 'Instal PROPWAY' : 'Install PROPWAY'}
  //             </a>
