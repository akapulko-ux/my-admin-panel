...
function PublicAdminLikePropertyDetail() {
  ...
  // uploads disabled on this page
  // uploads state not used on this page
  ...
  // removed service verification badge on this page
...
export default PublicAdminLikePropertyDetail;
